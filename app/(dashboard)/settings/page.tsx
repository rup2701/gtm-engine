// 1. Import the 'auth' function directly from your own auth file
...
export default async function SettingsPage() {
  // 2. Simply call auth() without passing any parameters
  ...
  // NextAuth v5 populates user.id directly if your JWT callback sets it
  ...
  // Check if this user has a LinkedIn account linked
