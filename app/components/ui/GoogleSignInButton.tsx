...
export default function GoogleSignInButton() {
  return (
    <button
      ...
      className="flex items-center justify-center gap-3 w-full max-w-sm px-4 py-2.5 border border-gray-300 rounded-md bg-white hover:bg-gray-50 text-gray-700 font-medium text-sm shadow-sm transition-colors duration-200"
    >
